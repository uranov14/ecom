          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title text-bold">Return Requests</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                      ...
                      <td>
                        <form action="{{ url('admin/return-requests/update') }}" method="POST">@csrf
                          ...
                          <select name="return_status" class="form-control">
                            <option @if ($request['return_status'] == "Approved")
                              selected
                            @endif value="Approved">Approved</option>
                            <option @if ($request['return_status'] == "Rejected")
                              selected
                            @endif value="Rejected">Rejected</option>
                            <option @if ($request['return_status'] == "Pending")
                              selected
