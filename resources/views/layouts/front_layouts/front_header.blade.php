		  ...
		  <div class="navbar">
		    <div class="navbar-inner">
		      <div class="container">
		        ...
		        <a class="brand" href="#" style="font-family: serif;"><i>Ukrainian Sector</i></a>
		        <div class="nav-collapse">
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu">
												@foreach ($section['categories'] as $category)
													<li class="divider"></li>
													<li class="nav-header">
														<a style="font-size: .8rem;" href="{{ url($category['url']) }}">
		          ...
		          <form class="navbar-search pull-left" action="{{ url('/search-products') }}">
		            <input type="text" name="search" id="search" class="search-query span2" placeholder="Search"/>
