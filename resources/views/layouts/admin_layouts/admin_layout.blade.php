...
<head>
  ...
  <link rel="shortcut icon" href="{{ url('images/admin_images/AdminLTELogo.png') }}">
  <!-- DataTables -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('gifs/ukraine_flag.gif') }}" alt="AdminLTELogo" height="80" width="100">
  </div>
