...
class OrdersController extends Controller
{
  ...
  public function returnRequests() {
    ...
    $returnRequests = ReturnRequest::get()->toArray();
    //echo "<pre>"; print_r($returnRequests); die;
    return view('admin.orders.return_requests')->with(compact('returnRequests'));
  }
  ...
  public function exchangeRequests() {
    ...
    $exchangeRequests = ExchangeRequest::get()->toArray();
    //echo "<pre>"; print_r($exchangeRequests); die;
    return view('admin.orders.exchange_requests')->with(compact('exchangeRequests'));
  }
